...
void GameScene::loadMap(int index)
{
    ...
    switch (index) {
    case 0: // Arena
        solids.append(addRect(310, 455, 180, 15, Qt::NoPen, pc));
        solids.append(addRect(100, 445, 140, 15, Qt::NoPen, pc));
        solids.append(addRect(560, 445, 140, 15, Qt::NoPen, pc));
        solids.append(addRect(360, 340, 80, 15, Qt::NoPen, ph));
        solids.append(addRect(180, 495, 45, 55, Qt::NoPen, bc));
        solids.append(addRect(575, 495, 45, 55, Qt::NoPen, bc));
        spawnSurfaces.append(QRectF(310, 445, 180, 10));
        spawnSurfaces.append(QRectF(100, 435, 140, 10));
        spawnSurfaces.append(QRectF(560, 435, 140, 10));
        spawnSurfaces.append(QRectF(360, 330, 80, 10));
        break;
    case 1: // Castle
        solids.append(addRect(290, 455, 220, 15, Qt::NoPen, pc));
        solids.append(addRect(35, 445, 130, 15, Qt::NoPen, pc));
        solids.append(addRect(635, 445, 130, 15, Qt::NoPen, pc));
        solids.append(addRect(330, 350, 140, 15, Qt::NoPen, pc));
        solids.append(addRect(50, 340, 110, 15, Qt::NoPen, pc));
        solids.append(addRect(640, 340, 110, 15, Qt::NoPen, pc));
        solids.append(addRect(365, 245, 70, 15, Qt::NoPen, ph));
        solids.append(addRect(150, 495, 45, 55, Qt::NoPen, bc));
        solids.append(addRect(605, 495, 45, 55, Qt::NoPen, bc));
        spawnSurfaces.append(QRectF(290, 445, 220, 10));
        spawnSurfaces.append(QRectF(35, 435, 130, 10));
        spawnSurfaces.append(QRectF(635, 435, 130, 10));
        spawnSurfaces.append(QRectF(330, 340, 140, 10));
        spawnSurfaces.append(QRectF(50, 330, 110, 10));
        spawnSurfaces.append(QRectF(640, 330, 110, 10));
        spawnSurfaces.append(QRectF(365, 235, 70, 10));
        break;
    case 2: // Towers —— 宽→窄，往中靠
        solids.append(addRect(310, 450, 180, 15, Qt::NoPen, pc));
        solids.append(addRect(70, 445, 90, 15, Qt::NoPen, pc));
        solids.append(addRect(640, 445, 90, 15, Qt::NoPen, pc));
        solids.append(addRect(340, 345, 120, 15, Qt::NoPen, pc));
        solids.append(addRect(85, 340, 65, 15, Qt::NoPen, pc));
        solids.append(addRect(650, 340, 65, 15, Qt::NoPen, pc));
        solids.append(addRect(360, 245, 70, 15, Qt::NoPen, ph));
        solids.append(addRect(95, 235, 45, 15, Qt::NoPen, ph));
        solids.append(addRect(660, 235, 45, 15, Qt::NoPen, ph));
        solids.append(addRect(145, 495, 45, 55, Qt::NoPen, bc));
        solids.append(addRect(610, 495, 45, 55, Qt::NoPen, bc));
        spawnSurfaces.append(QRectF(310, 440, 180, 10));
        spawnSurfaces.append(QRectF(70, 435, 90, 10));
        spawnSurfaces.append(QRectF(640, 435, 90, 10));
        spawnSurfaces.append(QRectF(340, 335, 120, 10));
        spawnSurfaces.append(QRectF(85, 330, 65, 10));
        spawnSurfaces.append(QRectF(650, 330, 65, 10));
        spawnSurfaces.append(QRectF(360, 235, 70, 10));
        spawnSurfaces.append(QRectF(95, 225, 45, 10));
        spawnSurfaces.append(QRectF(660, 225, 45, 10));
        break;
    case 3: // Cave —— 下宽上窄，往中收
        solids.append(addRect(240, 410, 105, 18, Qt::NoPen, QColor(55, 48, 40)));
        solids.append(addRect(455, 410, 105, 18, Qt::NoPen, QColor(55, 48, 40)));
        solids.append(addRect(300, 455, 200, 15, Qt::NoPen, pc));
        solids.append(addRect(65, 450, 140, 15, Qt::NoPen, pc));
        solids.append(addRect(595, 450, 140, 15, Qt::NoPen, pc));
        solids.append(addRect(340, 345, 120, 15, Qt::NoPen, pc));
        solids.append(addRect(80, 345, 105, 15, Qt::NoPen, pc));
        solids.append(addRect(615, 345, 105, 15, Qt::NoPen, pc));
        solids.append(addRect(370, 245, 60, 15, Qt::NoPen, ph));
        solids.append(addRect(195, 495, 45, 55, Qt::NoPen, bc));
        solids.append(addRect(560, 495, 45, 55, Qt::NoPen, bc));
        spawnSurfaces.append(QRectF(300, 445, 200, 10));
        spawnSurfaces.append(QRectF(65, 440, 140, 10));
        spawnSurfaces.append(QRectF(595, 440, 140, 10));
        spawnSurfaces.append(QRectF(340, 335, 120, 10));
        spawnSurfaces.append(QRectF(80, 335, 105, 10));
        spawnSurfaces.append(QRectF(615, 335, 105, 10));
        spawnSurfaces.append(QRectF(370, 235, 60, 10));
        break;
    }
}
